...
/**
 * Provides a Node.javascript 0.8 style [ReadStream](http://nodejs.org/docs/v0.8.21/api/stream.html#stream_readable_stream) interface for Queries.
 *
 ...
 *
 *
 * The stream interface allows us to simply "plug-in" to other _Node.javascript 0.8_ style write streams.
 *
 ...
 *
 * _NOTE: these streams are Node.javascript 0.8 style read streams which differ from Node.javascript 0.10 style. Node.javascript 0.10 streams are not well tested yet and are not guaranteed to work._
 *
 * @param {Query} query
